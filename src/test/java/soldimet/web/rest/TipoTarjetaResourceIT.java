...
/**
 * Integration tests for the {@link TipoTarjetaResource} REST controller.
 */
@SpringBootTest(classes = SoldimetApp.class)
public class TipoTarjetaResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static TipoTarjeta createUpdatedEntity(EntityManager em) {
        TipoTarjeta tipoTarjeta = new TipoTarjeta()
