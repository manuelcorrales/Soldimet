...
describe('Service Tests', () => {
    describe('EstadoCostoRepuesto Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EstadoCostoRepuestoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/estado-costo-repuestos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a EstadoCostoRepuesto', () => {
                service.create(new EstadoCostoRepuesto(null)).subscribe(received => {
            ...
            it('should update a EstadoCostoRepuesto', () => {
                service.update(new EstadoCostoRepuesto(123)).subscribe(received => {
            ...
            it('should return a EstadoCostoRepuesto', () => {
            ...
            it('should return a list of EstadoCostoRepuesto', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new EstadoCostoRepuesto(123)]);
            });
