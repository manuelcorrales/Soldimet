    ...
    describe('Persona Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Persona', () => {
                service.create(new Persona(null)).subscribe(received => {
            ...
            it('should update a Persona', () => {
                service.update(new Persona(123)).subscribe(received => {
