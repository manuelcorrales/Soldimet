    ...
    describe('EstadoArticulo Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/estado-articulos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a EstadoArticulo', () => {
                service.create(new EstadoArticulo(null)).subscribe(received => {
            ...
            it('should update a EstadoArticulo', () => {
                service.update(new EstadoArticulo(123)).subscribe(received => {
            ...
            it('should return a EstadoArticulo', () => {
            ...
            it('should return a list of EstadoArticulo', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new EstadoArticulo(123)]);
            });
