...
describe('Service Tests', () => {
    describe('Rubro Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(RubroService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/rubros';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Rubro', () => {
                service.create(new Rubro(null)).subscribe(received => {
            ...
            it('should update a Rubro', () => {
                service.update(new Rubro(123)).subscribe(received => {
