    ...
    describe('PagoTarjeta Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/pago-tarjetas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a PagoTarjeta', () => {
                service.create(new PagoTarjeta(null)).subscribe(received => {
            ...
            it('should update a PagoTarjeta', () => {
                service.update(new PagoTarjeta(123)).subscribe(received => {
            ...
            it('should return a PagoTarjeta', () => {
