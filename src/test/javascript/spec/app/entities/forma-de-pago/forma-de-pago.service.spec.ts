...
describe('Service Tests', () => {
    describe('FormaDePago Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(FormaDePagoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/forma-de-pagos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a FormaDePago', () => {
                service.create(new FormaDePago(null)).subscribe(received => {
            ...
            it('should update a FormaDePago', () => {
                service.update(new FormaDePago(123)).subscribe(received => {
            ...
            it('should return a FormaDePago', () => {
