...
describe('Service Tests', () => {
    describe('EstadoPresupuesto Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EstadoPresupuestoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/estado-presupuestos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a EstadoPresupuesto', () => {
                service.create(new EstadoPresupuesto(null)).subscribe(received => {
            ...
            it('should update a EstadoPresupuesto', () => {
                service.update(new EstadoPresupuesto(123)).subscribe(received => {
            ...
            it('should return a EstadoPresupuesto', () => {
            ...
            it('should return a list of EstadoPresupuesto', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new EstadoPresupuesto(123)]);
            });
