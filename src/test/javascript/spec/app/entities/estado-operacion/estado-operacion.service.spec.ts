...
describe('Service Tests', () => {
    describe('EstadoOperacion Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EstadoOperacionService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/estado-operacions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a EstadoOperacion', () => {
                service.create(new EstadoOperacion(null)).subscribe(received => {
            ...
            it('should update a EstadoOperacion', () => {
                service.update(new EstadoOperacion(123)).subscribe(received => {
            ...
            it('should return a EstadoOperacion', () => {
            ...
            it('should return a list of EstadoOperacion', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new EstadoOperacion(123)]);
            });
