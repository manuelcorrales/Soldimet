...
describe('Service Tests', () => {
    describe('CategoriaPago Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CategoriaPagoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/categoria-pagos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a CategoriaPago', () => {
                service.create(new CategoriaPago(null)).subscribe(received => {
            ...
            it('should update a CategoriaPago', () => {
                service.update(new CategoriaPago(123)).subscribe(received => {
            ...
            it('should return a CategoriaPago', () => {
            ...
            it('should return a list of CategoriaPago', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new CategoriaPago(123)]);
            });
