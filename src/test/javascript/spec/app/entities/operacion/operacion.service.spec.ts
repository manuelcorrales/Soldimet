    ...
    describe('Operacion Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/operacions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Operacion', () => {
                service.create(new Operacion(null)).subscribe(received => {
            ...
            it('should update a Operacion', () => {
                service.update(new Operacion(123)).subscribe(received => {
