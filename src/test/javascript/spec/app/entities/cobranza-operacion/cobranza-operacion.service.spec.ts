    ...
    describe('CobranzaOperacion Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/cobranza-operacions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a CobranzaOperacion', () => {
                service.create(new CobranzaOperacion(null)).subscribe(received => {
            ...
            it('should update a CobranzaOperacion', () => {
                service.update(new CobranzaOperacion(123)).subscribe(received => {
            ...
            it('should return a CobranzaOperacion', () => {
            ...
            it('should return a list of CobranzaOperacion', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new CobranzaOperacion(123)]);
            });
