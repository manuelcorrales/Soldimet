    ...
    describe('HistorialPrecio Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/historial-precios';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a HistorialPrecio', () => {
                service.create(new HistorialPrecio(null)).subscribe(received => {
            ...
            it('should update a HistorialPrecio', () => {
                service.update(new HistorialPrecio(123)).subscribe(received => {
            ...
            it('should return a HistorialPrecio', () => {
            ...
            it('should return a list of HistorialPrecio', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new HistorialPrecio(123)]);
            });
