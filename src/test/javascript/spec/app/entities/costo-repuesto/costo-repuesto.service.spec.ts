    ...
    describe('CostoRepuesto Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/costo-repuestos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a CostoRepuesto', () => {
                service.create(new CostoRepuesto(null)).subscribe(received => {
            ...
            it('should update a CostoRepuesto', () => {
                service.update(new CostoRepuesto(123)).subscribe(received => {
            ...
            it('should return a CostoRepuesto', () => {
            ...
            it('should return a list of CostoRepuesto', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new CostoRepuesto(123)]);
            });
