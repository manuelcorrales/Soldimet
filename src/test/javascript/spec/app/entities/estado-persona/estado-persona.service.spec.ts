    ...
    describe('EstadoPersona Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/estado-personas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a EstadoPersona', () => {
                service.create(new EstadoPersona(null)).subscribe(received => {
            ...
            it('should update a EstadoPersona', () => {
                service.update(new EstadoPersona(123)).subscribe(received => {
            ...
            it('should return a EstadoPersona', () => {
            ...
            it('should return a list of EstadoPersona', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new EstadoPersona(123)]);
            });
