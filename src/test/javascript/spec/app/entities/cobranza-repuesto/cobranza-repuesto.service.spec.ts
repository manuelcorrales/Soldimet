    ...
    describe('CobranzaRepuesto Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/cobranza-repuestos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a CobranzaRepuesto', () => {
                service.create(new CobranzaRepuesto(null)).subscribe(received => {
            ...
            it('should update a CobranzaRepuesto', () => {
                service.update(new CobranzaRepuesto(123)).subscribe(received => {
            ...
            it('should return a CobranzaRepuesto', () => {
            ...
            it('should return a list of CobranzaRepuesto', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new CobranzaRepuesto(123)]);
            });
