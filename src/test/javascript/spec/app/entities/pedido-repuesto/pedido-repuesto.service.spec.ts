    ...
    describe('PedidoRepuesto Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/pedido-repuestos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a PedidoRepuesto', () => {
                service.create(new PedidoRepuesto(null)).subscribe(received => {
            ...
            it('should update a PedidoRepuesto', () => {
                service.update(new PedidoRepuesto(123)).subscribe(received => {
            ...
            it('should return a PedidoRepuesto', () => {
            ...
            it('should return a list of PedidoRepuesto', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new PedidoRepuesto(123)]);
            });
