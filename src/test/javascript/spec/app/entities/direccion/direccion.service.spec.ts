    ...
    describe('Direccion Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/direccions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Direccion', () => {
                service.create(new Direccion(null)).subscribe(received => {
            ...
            it('should update a Direccion', () => {
                service.update(new Direccion(123)).subscribe(received => {
