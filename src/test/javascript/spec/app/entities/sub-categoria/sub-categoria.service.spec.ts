    ...
    describe('SubCategoria Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/sub-categorias';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a SubCategoria', () => {
                service.create(new SubCategoria(null)).subscribe(received => {
            ...
            it('should update a SubCategoria', () => {
                service.update(new SubCategoria(123)).subscribe(received => {
            ...
            it('should return a SubCategoria', () => {
            ...
            it('should return a list of SubCategoria', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new SubCategoria(123)]);
            });
