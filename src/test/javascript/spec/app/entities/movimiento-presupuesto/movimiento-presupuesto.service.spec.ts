...
describe('Service Tests', () => {
    describe('MovimientoPresupuesto Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(MovimientoPresupuestoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/movimiento-presupuestos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a MovimientoPresupuesto', () => {
                service.create(new MovimientoPresupuesto(null)).subscribe(received => {
            ...
            it('should update a MovimientoPresupuesto', () => {
                service.update(new MovimientoPresupuesto(123)).subscribe(received => {
            ...
            it('should return a MovimientoPresupuesto', () => {
            ...
            it('should return a list of MovimientoPresupuesto', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new MovimientoPresupuesto(123)]);
            });
