    ...
    describe('MedioDePagoCheque Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/medio-de-pago-cheques';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a MedioDePagoCheque', () => {
                service.create(new MedioDePagoCheque(null)).subscribe(received => {
            ...
            it('should update a MedioDePagoCheque', () => {
                service.update(new MedioDePagoCheque(123)).subscribe(received => {
            ...
            it('should return a MedioDePagoCheque', () => {
            ...
            it('should return a list of MedioDePagoCheque', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new MedioDePagoCheque(123)]);
            });
