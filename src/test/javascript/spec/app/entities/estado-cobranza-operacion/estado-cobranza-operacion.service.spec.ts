...
describe('Service Tests', () => {
    describe('EstadoCobranzaOperacion Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EstadoCobranzaOperacionService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/estado-cobranza-operacions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a EstadoCobranzaOperacion', () => {
                service.create(new EstadoCobranzaOperacion(null)).subscribe(received => {
            ...
            it('should update a EstadoCobranzaOperacion', () => {
                service.update(new EstadoCobranzaOperacion(123)).subscribe(received => {
            ...
            it('should return a EstadoCobranzaOperacion', () => {
            ...
            it('should return a list of EstadoCobranzaOperacion', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new EstadoCobranzaOperacion(123)]);
            });
