    ...
    describe('Caja Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/cajas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Caja', () => {
                service.create(new Caja(null)).subscribe(received => {
            ...
            it('should update a Caja', () => {
                service.update(new Caja(123)).subscribe(received => {
