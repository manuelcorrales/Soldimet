    ...
    describe('Movimiento Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/movimientos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Movimiento', () => {
                service.create(new Movimiento(null)).subscribe(received => {
            ...
            it('should update a Movimiento', () => {
                service.update(new Movimiento(123)).subscribe(received => {
