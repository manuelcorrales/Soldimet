...
describe('Service Tests', () => {
    describe('CostoOperacion Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CostoOperacionService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/costo-operacions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a CostoOperacion', () => {
                service.create(new CostoOperacion(null)).subscribe(received => {
            ...
            it('should update a CostoOperacion', () => {
                service.update(new CostoOperacion(123)).subscribe(received => {
            ...
            it('should return a CostoOperacion', () => {
            ...
            it('should return a list of CostoOperacion', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new CostoOperacion(123)]);
            });
