...
describe('Service Tests', () => {
    describe('TipoRepuesto Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TipoRepuestoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tipo-repuestos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a TipoRepuesto', () => {
                service.create(new TipoRepuesto(null)).subscribe(received => {
            ...
            it('should update a TipoRepuesto', () => {
                service.update(new TipoRepuesto(123)).subscribe(received => {
            ...
            it('should return a TipoRepuesto', () => {
            ...
            it('should return a list of TipoRepuesto', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new TipoRepuesto(123)]);
            });
