    ...
    describe('ListaPrecioDesdeHasta Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/lista-precio-desde-hastas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a ListaPrecioDesdeHasta', () => {
                service.create(new ListaPrecioDesdeHasta(null)).subscribe(received => {
            ...
            it('should update a ListaPrecioDesdeHasta', () => {
                service.update(new ListaPrecioDesdeHasta(123)).subscribe(received => {
            ...
            it('should return a ListaPrecioDesdeHasta', () => {
            ...
            it('should return a list of ListaPrecioDesdeHasta', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new ListaPrecioDesdeHasta(123)]);
            });
