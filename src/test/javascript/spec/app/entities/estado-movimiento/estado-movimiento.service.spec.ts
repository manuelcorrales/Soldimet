...
describe('Service Tests', () => {
    describe('EstadoMovimiento Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EstadoMovimientoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/estado-movimientos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a EstadoMovimiento', () => {
                service.create(new EstadoMovimiento(null)).subscribe(received => {
            ...
            it('should update a EstadoMovimiento', () => {
                service.update(new EstadoMovimiento(123)).subscribe(received => {
            ...
            it('should return a EstadoMovimiento', () => {
            ...
            it('should return a list of EstadoMovimiento', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new EstadoMovimiento(123)]);
            });
