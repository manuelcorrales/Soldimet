    ...
    describe('Empleado Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/empleados';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Empleado', () => {
                service.create(new Empleado(null)).subscribe(received => {
            ...
            it('should update a Empleado', () => {
                service.update(new Empleado(123)).subscribe(received => {
