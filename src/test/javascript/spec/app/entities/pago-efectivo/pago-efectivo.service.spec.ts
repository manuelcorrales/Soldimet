    ...
    describe('PagoEfectivo Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/pago-efectivos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a PagoEfectivo', () => {
                service.create(new PagoEfectivo(null)).subscribe(received => {
            ...
            it('should update a PagoEfectivo', () => {
                service.update(new PagoEfectivo(123)).subscribe(received => {
            ...
            it('should return a PagoEfectivo', () => {
            ...
            it('should return a list of PagoEfectivo', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new PagoEfectivo(123)]);
            });
