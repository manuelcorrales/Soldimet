...
describe('Service Tests', () => {
    describe('Localidad Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(LocalidadService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/localidads';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Localidad', () => {
                service.create(new Localidad(null)).subscribe(received => {
            ...
            it('should update a Localidad', () => {
                service.update(new Localidad(123)).subscribe(received => {
