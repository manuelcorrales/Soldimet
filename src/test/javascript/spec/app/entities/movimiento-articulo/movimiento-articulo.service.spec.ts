...
describe('Service Tests', () => {
    describe('MovimientoArticulo Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(MovimientoArticuloService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/movimiento-articulos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a MovimientoArticulo', () => {
                service.create(new MovimientoArticulo(null)).subscribe(received => {
            ...
            it('should update a MovimientoArticulo', () => {
                service.update(new MovimientoArticulo(123)).subscribe(received => {
            ...
            it('should return a MovimientoArticulo', () => {
            ...
            it('should return a list of MovimientoArticulo', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new MovimientoArticulo(123)]);
            });
