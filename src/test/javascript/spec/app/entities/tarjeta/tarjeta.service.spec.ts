    ...
    describe('Tarjeta Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tarjetas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Tarjeta', () => {
                service.create(new Tarjeta(null)).subscribe(received => {
            ...
            it('should update a Tarjeta', () => {
                service.update(new Tarjeta(123)).subscribe(received => {
