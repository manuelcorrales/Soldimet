...
describe('Service Tests', () => {
    describe('Aplicacion Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(AplicacionService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/aplicacions';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Aplicacion', () => {
                service.create(new Aplicacion(null)).subscribe(received => {
            ...
            it('should update a Aplicacion', () => {
                service.update(new Aplicacion(123)).subscribe(received => {
