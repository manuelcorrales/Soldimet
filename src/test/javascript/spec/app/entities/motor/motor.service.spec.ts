    ...
    describe('Motor Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/motors';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Motor', () => {
                service.create(new Motor(null)).subscribe(received => {
            ...
            it('should update a Motor', () => {
                service.update(new Motor(123)).subscribe(received => {
