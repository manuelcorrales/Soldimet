...
describe('Service Tests', () => {
    describe('EstadoPedidoRepuesto Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(EstadoPedidoRepuestoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/estado-pedido-repuestos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a EstadoPedidoRepuesto', () => {
                service.create(new EstadoPedidoRepuesto(null)).subscribe(received => {
            ...
            it('should update a EstadoPedidoRepuesto', () => {
                service.update(new EstadoPedidoRepuesto(123)).subscribe(received => {
            ...
            it('should return a EstadoPedidoRepuesto', () => {
            ...
            it('should return a list of EstadoPedidoRepuesto', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new EstadoPedidoRepuesto(123)]);
            });
