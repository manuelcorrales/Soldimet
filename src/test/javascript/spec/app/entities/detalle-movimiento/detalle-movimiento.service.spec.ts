    ...
    describe('DetalleMovimiento Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/detalle-movimientos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a DetalleMovimiento', () => {
                service.create(new DetalleMovimiento(null)).subscribe(received => {
            ...
            it('should update a DetalleMovimiento', () => {
                service.update(new DetalleMovimiento(123)).subscribe(received => {
            ...
            it('should return a DetalleMovimiento', () => {
            ...
            it('should return a list of DetalleMovimiento', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new DetalleMovimiento(123)]);
            });
