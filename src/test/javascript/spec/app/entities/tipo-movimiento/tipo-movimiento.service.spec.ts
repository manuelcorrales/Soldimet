    ...
    describe('TipoMovimiento Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tipo-movimientos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a TipoMovimiento', () => {
                service.create(new TipoMovimiento(null)).subscribe(received => {
            ...
            it('should update a TipoMovimiento', () => {
                service.update(new TipoMovimiento(123)).subscribe(received => {
            ...
            it('should return a TipoMovimiento', () => {
            ...
            it('should return a list of TipoMovimiento', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new TipoMovimiento(123)]);
            });
