    ...
    describe('MedioDePago Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/medio-de-pagos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a MedioDePago', () => {
                service.create(new MedioDePago(null)).subscribe(received => {
            ...
            it('should update a MedioDePago', () => {
                service.update(new MedioDePago(123)).subscribe(received => {
            ...
            it('should return a MedioDePago', () => {
