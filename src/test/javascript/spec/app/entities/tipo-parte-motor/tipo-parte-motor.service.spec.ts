...
describe('Service Tests', () => {
    describe('TipoParteMotor Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TipoParteMotorService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/tipo-parte-motors';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a TipoParteMotor', () => {
                service.create(new TipoParteMotor(null)).subscribe(received => {
            ...
            it('should update a TipoParteMotor', () => {
                service.update(new TipoParteMotor(123)).subscribe(received => {
            ...
            it('should return a TipoParteMotor', () => {
            ...
            it('should return a list of TipoParteMotor', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new TipoParteMotor(123)]);
            });
