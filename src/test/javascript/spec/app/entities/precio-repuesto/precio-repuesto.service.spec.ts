    ...
    describe('PrecioRepuesto Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/precio-repuestos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a PrecioRepuesto', () => {
                service.create(new PrecioRepuesto(null)).subscribe(received => {
            ...
            it('should update a PrecioRepuesto', () => {
                service.update(new PrecioRepuesto(123)).subscribe(received => {
            ...
            it('should return a PrecioRepuesto', () => {
            ...
            it('should return a list of PrecioRepuesto', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new PrecioRepuesto(123)]);
            });
