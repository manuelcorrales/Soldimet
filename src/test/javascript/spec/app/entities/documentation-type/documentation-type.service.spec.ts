    ...
    describe('DocumentationType Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/documentation-types';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a DocumentationType', () => {
                service.create(new DocumentationType(null)).subscribe(received => {
            ...
            it('should update a DocumentationType', () => {
                service.update(new DocumentationType(123)).subscribe(received => {
            ...
            it('should return a DocumentationType', () => {
            ...
            it('should return a list of DocumentationType', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new DocumentationType(123)]);
            });
