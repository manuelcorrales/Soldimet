    ...
    describe('Marca Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/marcas';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Marca', () => {
                service.create(new Marca(null)).subscribe(received => {
            ...
            it('should update a Marca', () => {
                service.update(new Marca(123)).subscribe(received => {
