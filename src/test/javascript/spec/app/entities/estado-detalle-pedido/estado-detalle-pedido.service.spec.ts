    ...
    describe('EstadoDetallePedido Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/estado-detalle-pedidos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a EstadoDetallePedido', () => {
                service.create(new EstadoDetallePedido(null)).subscribe(received => {
            ...
            it('should update a EstadoDetallePedido', () => {
                service.update(new EstadoDetallePedido(123)).subscribe(received => {
            ...
            it('should return a EstadoDetallePedido', () => {
            ...
            it('should return a list of EstadoDetallePedido', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new EstadoDetallePedido(123)]);
            });
