...
describe('Service Tests', () => {
    describe('MovimientoPedido Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(MovimientoPedidoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/movimiento-pedidos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a MovimientoPedido', () => {
                service.create(new MovimientoPedido(null)).subscribe(received => {
            ...
            it('should update a MovimientoPedido', () => {
                service.update(new MovimientoPedido(123)).subscribe(received => {
            ...
            it('should return a MovimientoPedido', () => {
            ...
            it('should return a list of MovimientoPedido', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new MovimientoPedido(123)]);
            });
