...
describe('Service Tests', () => {
    describe('DetallePresupuesto Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(DetallePresupuestoService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/detalle-presupuestos';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a DetallePresupuesto', () => {
                service.create(new DetallePresupuesto(null)).subscribe(received => {
            ...
            it('should update a DetallePresupuesto', () => {
                service.update(new DetallePresupuesto(123)).subscribe(received => {
            ...
            it('should return a DetallePresupuesto', () => {
            ...
            it('should return a list of DetallePresupuesto', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new DetallePresupuesto(123)]);
            });
