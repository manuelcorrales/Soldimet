    ...
    describe('PagoCheque Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/pago-cheques';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a PagoCheque', () => {
                service.create(new PagoCheque(null)).subscribe(received => {
            ...
            it('should update a PagoCheque', () => {
                service.update(new PagoCheque(123)).subscribe(received => {
