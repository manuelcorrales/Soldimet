...
public class CajaResource {
    ...
    public CajaResource(CajaService cajaService, CajaRepository cajaRepository, CajaQueryService cajaQueryService) {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/cajas/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<Caja> partialUpdateCaja(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, caja.getId().toString())
        );
    }
