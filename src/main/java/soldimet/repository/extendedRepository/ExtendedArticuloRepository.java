...
public interface ExtendedArticuloRepository extends ArticuloRepository {
    ...
    Page<Articulo> findByEstadoAndCodigoArticuloProveedorContainsOrderByIdDesc(EstadoArticulo estadoArticulo, String codigo, Pageable page);

    Page<Articulo> findByEstadoAndCodigoArticuloProveedorContainsAndMarcaIdOrderByIdDesc(
