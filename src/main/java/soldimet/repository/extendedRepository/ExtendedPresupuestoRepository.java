...
public interface ExtendedPresupuestoRepository extends PresupuestoRepository {
    public String queryPresupuestoFiltrandoSucursal =
        "SELECT " +
        "pre.*, det.* " +
    ...
    @EntityGraph(
        attributePaths = {
            "detallePresupuestos",
            "detallePresupuestos.motor",
            "sucursal",
            "detallePresupuestos.aplicacion",
            "detallePresupuestos.tipoParteMotor",
            "detallePresupuestos.cilindrada",
            "detallePresupuestos.cobranzaOperacions",
            "detallePresupuestos.cobranzaRepuestos",
            "detallePresupuestos.cobranzaRepuestos.articulo.marca",
            "detallePresupuestos.cobranzaRepuestos.articulo.tipoRepuesto",
            "detallePresupuestos.cobranzaRepuestos.articulo",
            "detallePresupuestos.cobranzaRepuestos.tipoRepuesto",
            "detallePresupuestos.cobranzaOperacions.operacion",
            "cliente",
            "cliente.persona",
            "estadoPresupuesto",
        }
    )
    public Page<Presupuesto> (
        Long estadoId,
        String nombre,
        Long sucursal,
        Boolean modelo,
    ...
    public Page<Presupuesto> (
        String nombre,
        Long sucursal,
        Boolean modelo,
        String apellido,
    ...
    public List<Presupuesto> findBySucursalAndFechaCreacionGreaterThanEqualAndFechaCreacionLessThanEqualAndEstadoPresupuestoIn(
        ...
        LocalDate fechaFin,
        List<EstadoPresupuesto> estados
    );
