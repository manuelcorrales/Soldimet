...
import soldimet.repository.extendedRepository.ExtendedEstadoOperacionRepository;
...
public class EstrategiaPresupuestoRectificacionCRAMExcel extends EstrategiaPresupuestoRectificacionCRAM {
    ...
    @Autowired
    private ExtendedEstadoOperacionRepository estadoOperacionRepository;
    ...
    public List<CostoOperacion> buscarOperaciones(Cilindrada cilindros, Motor motor, Aplicacion aplicacion,
        ...
        // busco las operaciones de esta lista que tengan el estado Alta y lo agrego a
        // la lista de DTO
