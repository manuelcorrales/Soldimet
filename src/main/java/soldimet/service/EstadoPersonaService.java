...
/**
 * Service Implementation for managing EstadoPersona.
 */
@Service
@Transactional
public class EstadoPersonaService {
     ...
     */
    @Transactional(readOnly = true)
    public EstadoPersona findOne(Long id) {
        log.debug("Request to get EstadoPersona : {}", id);
        return estadoPersonaRepository.findOne(id);
    }
    ...
    public void delete(Long id) {
        ...
        estadoPersonaRepository.delete(id);
    }
}
