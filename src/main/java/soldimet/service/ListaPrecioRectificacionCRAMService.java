...
public class ListaPrecioRectificacionCRAMService {
     ...
     */
    @Transactional(readOnly = true)
    public ListaPrecioRectificacionCRAM findOne(Long id) {
        log.debug("Request to get ListaPrecioRectificacionCRAM : {}", id);
        return listaPrecioRectificacionCRAMRepository.findOne(id);
    }
    ...
    public void delete(Long id) {
        ...
        listaPrecioRectificacionCRAMRepository.delete(id);
    }
}
