...
export class PresupuestoService {
  ...
  protected convertDateFromClient(presupuesto: IPresupuesto): IPresupuesto {
    const copy: IPresupuesto = Object.assign({}, presupuesto, {
      fechaCreacion:
        presupuesto.fechaCreacion != null && presupuesto.fechaCreacion.isValid() ? presupuesto.fechaCreacion.format(DATE_FORMAT) : null,
      fechaAceptado:
        presupuesto.fechaAceptado != null && presupuesto.fechaAceptado.isValid() ? presupuesto.fechaAceptado.format(DATE_FORMAT) : null,
      fechaEntregado:
        presupuesto.fechaEntregado != null && presupuesto.fechaEntregado.isValid() ? presupuesto.fechaEntregado.format(DATE_FORMAT) : null
    });
    return copy;
  }
