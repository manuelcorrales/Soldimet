  ...
  describe('Banco Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should update editForm', () => {
        ...
        expect(comp.editForm.value).toEqual(expect.objectContaining(banco));
      });
    });
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        // GIVEN
        const saveSubject = new Subject<HttpResponse<Banco>>();
        const banco = { id: 123 };
        ...
        expect(bancoService.update).toHaveBeenCalledWith(banco);
      ...
      it('Should call create service on save for new entity', () => {
        ...
        // THEN
        expect(bancoService.create).toHaveBeenCalledWith(banco);
        expect(comp.isSaving).toEqual(false);
        expect(comp.previousState).toHaveBeenCalled();
      });
