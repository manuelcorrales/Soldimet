  ...
  imports: [
    RouterModule.forChild([
      ...
      },
      {
        ...
        loadChildren: () =>
          import('app/entities/estado-presupuesto/estado-presupuesto.module').then(m => m.SoldimetEstadoPresupuestoModule),
      },
      {
        path: 'forma-de-pago',
      ...
      },
      {
        ...
        loadChildren: () =>
          import('app/entities/detalle-movimiento/detalle-movimiento.module').then(m => m.SoldimetDetalleMovimientoModule),
      },
      {
        path: 'cobranza-operacion',
        loadChildren: () =>
          import('app/entities/cobranza-operacion/cobranza-operacion.module').then(m => m.SoldimetCobranzaOperacionModule),
      },
      {
      ...
      },
      {
        ...
        loadChildren: () =>
          import('app/entities/documentation-type/documentation-type.module').then(m => m.SoldimetDocumentationTypeModule),
      },
      {
        path: 'sucursal',
